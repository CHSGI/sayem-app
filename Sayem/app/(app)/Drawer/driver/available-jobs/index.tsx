...
const HeaderComponent = () => {
  ...
  return (
    <View>
      <Text style={tw`font-Medium text-lg text-primary`}>4 Jobs</Text>
      <View style={tw`my-3 flex flex-row items-center gap-4`}>
        {/* filter job by type  */}
        ...
        <View style={tw`flex-1`}>
          <TextSelect
            ...
            setSelectState={() => setViews({ ...views, pay: !views.pay })}
          />
        </View>
      </View>
    </View>
  ...
  return (
    <View style={tw`my-3 bg-white p-5 rounded-lg border border-gray-200`}>
      ...
      <CustomButton
        title="View Details"
        onPress={() => {
          router.push("/Drawer/driver/available-jobs/job-details");
        }}
      />
    </View>
  );
...
const AvailableJobs = () => {
  return (
    <DrawerContainer title="Available Jobs">
      <FlatList
        data={[{}]}
        style={tw`p-5`}
